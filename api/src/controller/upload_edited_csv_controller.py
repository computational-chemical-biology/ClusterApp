...
class UploadEditedCsvController:
    ...
    def executeUploadEditedCsv(self):
        ...
        dataProcessingConfig = DataProcessingConfig(metric= self.request.form['metric'], scaling= self.request.form['scaling'],normalization= self.request.form['normalization'],taskId= None, workflow= None, filterBlanks= filterBlanks,method=self.request.form['method'])
